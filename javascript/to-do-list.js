let toDoList = function (p) { //template to make versions of sketch
    ...
    p.setup = function () {
        ...
        p.h2.parent('to-do-list');

        p.canvas = p.createCanvas(300, 360);
        p.canvas.parent('to-do-list');
    ...
    p.draw = function () {
        ...
        p.text('• m̶a̶k̶e̶ ̶p̶e̶r̶s̶o̶n̶a̶l̶i̶z̶e̶d̶ ̶f̶o̶n̶t̶', p.x, p.y + (p.lineheight * 2.4), p.pw, p.ph);
        //to-do's
        p.text('• l̶a̶y̶ ̶o̶u̶t̶ ̶i̶t̶e̶m̶s̶ ̶i̶n̶ ̶C̶S̶S̶ ̶g̶r̶i̶d̶', p.x, p.y + (p.lineheight * 3.4), p.pw, p.ph);
